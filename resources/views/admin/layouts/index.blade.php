...
<head>
    ...
    <title>Admin - Ternyata Hoaks</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">Ternyata Hoaks</div>
            </a>
            ...
            <li class="nav-item @if ($active == 'unreviewed') active @endif">
                <a class="nav-link" href="/admin/dashboard/unreviewed" id="ajax-button">
                    ...
                    <span class="ml-1">Unreviewed Reports</span></a>
            </li>
            <hr class="sidebar-divider my-0">
            <li class="nav-item @if ($active == 'reviewed') active @endif">
                <a class="nav-link" href="/admin/dashboard/reviewed">
                    ...
                    <span class="ml-1">Reviewed Reports</span></a>
            </li>
            ...
            <li class="nav-item @if ($active == 'manage') active @endif">
                <a class="nav-link" href="/admin/dashboard/manage">
                    ...
                    <span class="ml-1">Manage Admins</span></a>
                </li>       
            <hr class="sidebar-divider my-0">
            <li class="nav-item @if ($active == 'manage-users') active @endif">
                <a class="nav-link" href="/admin/dashboard/manage-users">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                        <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                        <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"/>
                        <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                    </svg>
                    <span class="ml-1">Manage Users</span></a>
            </li>     
            @endif
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    @if (auth('admins')->user() !== null)
                                        {{ auth('admins')->user()->username }}
                                    @else
                                        Admin
                                    @endif
                                </span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Diskominfotik | Ternyata Hoaks 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
