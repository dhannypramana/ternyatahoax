        ...
        <div class="col-lg-8">
            ...
            <article>
                ...
                <header class="mb-4">
                    ...
                    <!-- Post meta content-->
                    <div class="text-muted fst-italic mb-2">Reported by {{ $report->user->full_name }} on {{ $report->created_at->format('j F Y, H:i a') }} {{ $report->created_at->diffForHumans() }}</div>
                ...
                @if ($report->image != null)
                        <img class="card-img-top" height="400" style="object-fit: cover" src="{{ asset('/storage/images/' . $report->image) }}"/>
                @else
