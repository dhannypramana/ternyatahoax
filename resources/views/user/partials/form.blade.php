        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="form-group col-lg-6">
              ...
              <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Ini Judul">
            </div>
          </div>
          <div class="row justify-content-center">
            <div class="form-group col-lg-6">
          ...
          <div class="row justify-content-center">
            <div class="form-group col-lg-6">
                ...
                <input type="url" class="form-control" id="exampleFormControlInput1" placeholder="ini link">
            </div>    
          </div>
